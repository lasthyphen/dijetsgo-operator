...
# djtx.network/avalanchego-operator-bundle:$VERSION and djtx.network/avalanchego-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= djtx.network/avalanchego-operator
